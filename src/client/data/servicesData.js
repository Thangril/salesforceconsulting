const SERVICES_DATA = [
    ...
    {
        title:'Salesforce Developement',
        image:'./resources/Images/Services_section/development.svg',
        color:'green',
        description:'We offer Salesforce Developement services that include robust automation, complex logic implementation, and custome Salesforce solutions' ,
    ...
    },
    {
        ...
        color:'yellow',
        description:'Our Certified Salesforce Consultants can help you maximize the value of your business by reconizing challenges and implement tools and strategize to be more productive',
    },
    {
        title:'Salesforce Integration',
        image:'./resources/Images/Services_section/integration.svg',
        color:'red',
        description:'Connect and integrate your business data from your system to develope a unified view of your customer base',
    },
    {
    ...
    },
    {
        ...
        color:'skyblue',
        description:"We'll assist you in migrating to Salesforce CRM, safely converting all customer data and streamline",
    }
